...
function createUniqueRoomCode(data, randomInt = crypto.randomInt) {
  ...
  // Random retries become unreliable as the eight-digit namespace fills up.
  // A bounded deterministic fallback still finds every remaining free code.
  for (let candidate = 10_000_000; candidate < 100_000_000; candidate += 1) {
