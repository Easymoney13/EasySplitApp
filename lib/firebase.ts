...
// Public Firebase client identifier, not a server credential. Keep this key
// restricted to the required Firebase APIs in Google Cloud (never Gemini).
// https://firebase.google.com/docs/projects/api-keys
// Retain the deployed default for builds without an explicit public override.
const firebaseApiKey = process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyBQmeJV8TR77XGRSybwTJXA6HZXh8DmGx8";
