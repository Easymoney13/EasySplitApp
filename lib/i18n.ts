export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    startSplitCard: "start\nsplit",
    letTryItNow: "Let's try it now",
    joinSessionViaCode: "join session\nvia code",
    createAGroupCard: "create a\ngroup",
    seeAll: "See All",
  ...
  he: {
    ...
    startSplitCard: "התחל\nחלוקה",
    letTryItNow: "בואו ננסה עכשיו",
    joinSessionViaCode: "הצטרף לחדר\nבאמצעות קוד",
    createAGroupCard: "צור\nקבוצה",
    seeAll: "הצג הכל",
